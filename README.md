...
These are the projects that best represent the kind of engineering I care about: useful systems, workflow automation, security-minded boundaries, and tools that reduce manual work.

| Project | Direction | Why it stands out |
|---|---|---|
| [`EyeGate-L / Luckfox SCUD`](https://github.com/ShapArt/eyegate-l-luckfox-scud) | Computer vision / edge / access control | One of the strongest technical projects: face and liveness-oriented access-control prototype for constrained hardware, combining CV, local deployment, and security thinking |
| [`SLA / Outlook Tracker`](https://github.com/ShapArt/outlook-exporter) | Office automation / reporting | Turns mailbox-driven operational work into structured data, Excel reports, and status tracking instead of manual copy-paste |
| [`Matrtix-Cleaner`](https://github.com/ShapArt/Matrtix-Cleaner) | Browser automation / OpenText | Guarded bulk changes for approval matrices with preview, audit, and operator control — practical automation in a risky enterprise workflow |
| [`OpenText Operator Bridge`](https://github.com/ShapArt/opentext-operator-bridge) | Backend / workflow tooling | Intake, triage, and bounded action planning for OpenText-related support scenarios; strong example of workflow orchestration, not just CRUD |
| [`Sh4pArt VPN`](https://github.com/ShapArt/vpn-bot-stars-hiddify) | Backend / Telegram bot / infra | Payment, provisioning, profile delivery, and reminder flow for a VPN subscription backend; connects bot UX with real service delivery |
| [`Ozon Tickets Export`](https://github.com/ShapArt/tampermonkey-ozon-tickets-export) | Browser helper / operator tooling | Small but useful automation layer for ticket export and review inside an existing browser workflow |
...
- [`cases-and-achievements`](https://github.com/ShapArt/cases-and-achievements) — curated case write-ups and achievements
...
Самые сильные проекты для просмотра: EyeGate-L, SLA / Outlook Tracker, Matrtix-Cleaner, OpenText Operator Bridge и Sh4pArt VPN.
